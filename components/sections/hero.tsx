          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-lg text-muted-foreground max-w-lg leading-relaxed">
                Men toza kod va yuqori unumdorlikka asoslangan, qulay va ishonchli web-ilovalar hamda CRM tizimlar yarataman. Maqsadim — foydalanuvchi tajribasini va biznes samaradorligini oshirish.
              </p>
            </div>
